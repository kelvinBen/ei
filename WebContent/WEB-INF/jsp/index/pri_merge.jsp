...
<div>
	...
	<thead>
	<tr>
	   <th width="150"><INPUT type="hidden" value="purchaseRequisition.orgName"/><s:text name="pr.header.company"/></th>
	   <th width="80"><s:text name="pr.header.number"/></th>
	   ...
	   <th width="60"><INPUT type="hidden" value="product"/><s:text name="pri.product"/></th>
	 ...
	 <s:else>
		...
		<s:iterator value="purchaseRequisitionItemList" status="position" var="purchaseRequisitonItem" begin="0" end="#endPosition-1">
		 <tr>
		    ...
		    <td><s:property value="getText(#purchaseRequisitonItem.type)"/></td>
