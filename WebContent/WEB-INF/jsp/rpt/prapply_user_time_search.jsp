...
<body>
	<div class="editdiv">
<s:form id="frm" namespace="/rpt" action="prapply_user_time_list" theme="simple">
<input type="hidden" name="procurementOperator" value=""/>
	...
	<tr>
		<th class="tdTitle">审批人姓名</th>
		<td class="TdRight">
			<s:textfield name="userName" theme="simple" id="userName"></s:textfield>
		</td>		
	</tr>
	<tr>
