...
<script type="text/javascript">
	$(function() {
		$("#export_selected").click(function(){
			$("#mainForm").attr("action",'<s:url namespace="/history/common" action="export"/>');
			$("#mainForm").submit();
		});	
	});
</script>
...
<s:form id="mainForm" namespace="/history/common" action="list" theme="simple" method="get">
	<div>
		...
		<tbody>
			<s:iterator value="page.result" id="mhi">
				<tr>
					...
					<s:else><s:property value="modifyHistory.targetId" /></s:else>
					]</td>
