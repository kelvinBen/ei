...
$(function(){
	...
	$('#select_new').click(function(){
		window.location.href="<s:url namespace='/user/search' action='searchCheckboxList'/>";		
	});
...
<body> 
<div class="editdiv">
	<s:form id="list" namespace="/user/search" action="searchCheckboxList" theme="simple" method="post"> 
	<table class="tblContent" width="100%" cellpadding="0">
		...
		<tr>
		   ...
		   <td class="TdRight"><s:textfield size="12" maxlength="12" id="purNumber" name="userCondition.userName"/></td>
		</tr>
		<tr>
		  ...
		  <div class="selectCon">
		    <div style="text-align:center"><s:text name='pr.mange.to'/></div>
		  	<div><select id="nexStatus" name="userCondition.userDepartment" multiple></select></div>
		  </div>		  
		  </td>
		</tr>
		<tr>
		  ...
		  <div class="selectCon">
		    <div style="text-align:center"><s:text name='pr.mange.to'/></div>
		  	<div><select id="nexDistStat" name="userCondition.userPosition" multiple></select></div>
		  </div>		  
		  </td>
		</tr>
		<tr>
		  ...
		  <div class="selectCon">
		    <div style="text-align:center"><s:text name='pr.mange.to'/></div>
		  	<div><select id="nexSubStat" name="userCondition.userDuty" multiple></select></div>
		  </div>		  
		  </td>
		</tr>
		<tr>
		...
		<table class="tblContent4list" style="table-layout:fixed;word-break:break-all;" cellpadding="0">
	        ...
	        <tr>
	          ...
	          <td><input type="checkbox" name="ids" value="<s:property value='#user.userId'/>" class="ids"/></td>
	        </tr>
	        <script type="text/javascript">
	        	jsonTemp = {};
