...
function XMLTree(menuName) {
	...
	this.defClass="clsCurrentFocus"	;				//当前节点样式    
...
if(xmlDoc.childNodes.length>0){
	...
	*/
		...
		for (var i=0;i<xmlDoc.childNodes.length;i++) {
			...
			if (xmlDoc.childNodes[i].getAttribute("nodeType") == "node")
			...
			else if (xmlDoc.childNodes[i].getAttribute("nodeType") == "leaf")
			...
			else if (xmlDoc.childNodes[i].getAttribute("nodeType") == "ref")
