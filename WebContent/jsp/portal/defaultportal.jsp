	...
	<%if(PermitBeanFactory.hasPermission(userinfo,"proposalportalAction.cmd?method=auditlist")){ %>
		...
		<table width="100%" border=0 height="100%" cellpadding=0 cellspacing=0
			...
			<tr height="23" class="portaltd1bgimg">
				...
				<td width="99%" class="portal_title_td"><a><b>提案审查</b></a></td>
			</tr>
			<tr height="99%">
				<td colspan=2><iframe src="<%=app %>/proposalportalAction.cmd?method=auditlist" width="100%"
					height="100%" scrolling=auto frameborder=0></iframe></td>
			</tr>
		</table>
		</td>
	<%}
	if(PermitBeanFactory.hasPermission(userinfo,"proposalportalAction.cmd?method=userlist")){	
	%>
		<td colspan="1" rowspan="1" valign=top>
		<table width="100%" border=0 height="100%" cellpadding=0 cellspacing=0
			class="portal_title_tab">
<tr height="23" class="portaltd1bgimg">
				<td nowrap width="24" class="portaltd2bgimg">&nbsp;</td>
				<td width="99%" class="portal_title_td"><a><b>我的提案</b></a></td>
			</tr>
			<tr height="99%">
				<td colspan=2><iframe
					src="<%=app %>/proposalportalAction.cmd?method=userlist" width="100%"
					height="100%" scrolling=auto frameborder=0></iframe></td>
			</tr>
		</table>
		</td>
	...
	<tr>
	<%if(PermitBeanFactory.hasPermission(userinfo,"proposalportalAction.cmd?method=jiaobanlist")){ %>
		<td colspan="1" rowspan="1" valign=top>
		<table width="100%" border=0 height="100%" cellpadding=0 cellspacing=0
			class="portal_title_tab">
			<tr height="23" class="portaltd1bgimg">
				<td nowrap width="24" class="portaltd2bgimg">&nbsp;</td>
				<td width="99%" class="portal_title_td"><a><b>提案交办</b></a></td>
			</tr>
			<tr height="99%">
				<td colspan=2><iframe src="<%=app %>/proposalportalAction.cmd?method=jiaobanlist"
					width="100%" height="100%" scrolling=auto frameborder=0></iframe></td>
			</tr>
		</table>
		</td>
		<%}
	if(PermitBeanFactory.hasPermission(userinfo,"proposalportalAction.cmd?method=deptlist")){	
	%>
		<td colspan="1" rowspan="1" valign=top>
		<table width="100%" border=0 height="100%" cellpadding=0 cellspacing=0
			class="portal_title_tab">
<tr height="23" class="portaltd1bgimg">
				<td nowrap width="24" class="portaltd2bgimg">&nbsp;</td>
				<td width="99%" class="portal_title_td"><a><b>提案办理</b></a></td>
			</tr>
			<tr height="99%">
				<td colspan=2><iframe
					src="<%=app %>/proposalportalAction.cmd?method=deptlist" width="100%"
					height="100%" scrolling=auto frameborder=0></iframe></td>
			</tr>
		</table>
		</td>	
