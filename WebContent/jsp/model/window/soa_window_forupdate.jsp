...
<bsp:container title="窗口模型修改" >
<bsp:containbutton action="soawindow.cmd?method=update" text="保存" onclick="forSave()"></bsp:containbutton>
...
function forSave(){
  ...
  document.forms[0].action ="soawindow.cmd?method=update";
