...
<bsp:container title="tab模型增加" >
<bsp:containbutton action="soatab.cmd?method=insert" text="保存" onclick="forSave()"></bsp:containbutton>
...
<div align="center">
  <table width="100%" cellpadding="0" class="tblContent">  
                    ...
                    <td><html:text name="pmId" property="pmId" size="32" maxlength="32" />
                    <img src="skins/default/images/liulan.gif" width="28" style="cursor:hand" height="16" border="0" onclick="selectPm()"></td>
					</tr>
				    <tr>
                    ...
                    <td class="tdRight">
                    	<html:select name="isMain" property="isMain" value="1">
                    ...
                    <td class="tdRight">
                    	<html:select name="isDetail" property="isDetail" value="1">
                    ...
                    <td class="tdRight">
                    	<html:select name="isSameTab" property="isSameTab" value="1">
                    ...
                    <td class="tdRight">
                    	<html:radioGroup name="isReadOnly" property="isReadOnly" value="none" collection="SOATAB_ISREADONLY_COLLECTION" labelProperty="value" labelKey="key"/>
	                </td>
                    </tr>
					<tr>
...
function forSave(){
  ...
  document.forms[0].action ="soatab.cmd?method=insert";
