...
<bsp:container title="属性域增加" >
<bsp:containbutton action="soacolumn.cmd?method=insert" text="保存" onclick="forSave()"></bsp:containbutton>
...
<div align="center">
  <table width="100%" cellpadding="0" class="tblContent">  
                    ...
                    <td class="tdRight">
                    	<html:select name="isNotNull" property="isNotNull" value="1">
                    ...
                    <td class="tdRight">
                    	<html:select name="keyType" property="keyType" value="1">
                    ...
                    <td class="tdRight">
                    	<html:select name="keyGenerator" property="keyGenerator" value="0">
                    ...
                    <td class="tdRight">
                    	<html:select name="isSearch" property="isSearch" value="0">
...
function forSave(){
  ...
  document.forms[0].action ="soacolumn.cmd?method=insert";
