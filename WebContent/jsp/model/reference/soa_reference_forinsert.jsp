...
<bsp:container title="关联模型增加" >
<bsp:containbutton action="soareference.cmd?method=insert" text="保存" onclick="forSave()"></bsp:containbutton>
<bsp:containbutton action="soareference.cmd?method=insertContinue" text="保存并继续" onclick="forSaveContinue()"></bsp:containbutton>
...
function forSave(){
  ...
  document.forms[0].action ="soareference.cmd?method=insert";
  document.forms[0].submit();	
}
function forSaveContinue(){
  if(!checkSoaReference()) return;
  document.forms[0].action ="soareference.cmd?method=insertContinue";
  document.forms[0].submit();	
}
function forReturn(){
