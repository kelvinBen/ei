...
<bsp:container title="持久模型增加" >
<bsp:containbutton action="permanence.cmd?method=insert" text="保存" onclick="forSave()"></bsp:containbutton>
...
<div align="center">
  <table width="100%" cellpadding="0" class="tblContent">  
                    ...
                    <td class="tdRight">
                    	<html:select name="isCache" property="isCache" value="1">
...
function forSave(){
  ...
  document.forms[0].action ="permanence.cmd?method=insert";
