...
<html:form name="frmList" action="inboxmailquery.cmd?mailType=0&mailStatus=0">
...
<flex:pagePolit action="inboxmailquery.cmd?mailType=0&mailStatus=0">
</flex:pagePolit>
</bsp:container>
</html:form>
<!-- loading...图片 -->
...
function forDetail()
{
	...
	window.location.href="mailresource.cmd?method=detail&primaryKey="+grid.getCellValue(rowIndex,1)+"&mailStatus=0";
}
...
function forReceive()
{
  ...
  initMessage();
  document.forms[0].action ="inboxmailquery.cmd?mailType=0&receiveMail=1&mailStatus=0";  
