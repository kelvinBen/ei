...
<% 
	...
	String url2="sendmailquery.cmd?mailType=1&fullName="+fullName;
...
function forThoroughDelete(){
  ...
  document.forms[0].action ="mailresource.cmd?method=thoroughDelete&mailType=1";    
  document.forms[0].submit();	
}
function forDelete(){
  if(!getDelete()) return;
  document.forms[0].action ="mailresource.cmd?method=delete&mailType=1";    
  document.forms[0].submit();	
}
function doUpdate(){
...
function moveTo(){
	...
	document.forms[0].action ="mailresource.cmd?method=copyToFolder&mailType=1&folderFullName="+folderFullName;   
	document.forms[0].submit();
}
function getMove(){
var sel=grid.getCheckLine();
