...
<bsp:container title="系统菜单项增加" >
<bsp:containbutton action="menusysitem.cmd?method=insert" text="保存" onclick="forSave()"></bsp:containbutton>
<bsp:containbutton action="menusysitem.cmd?method=insertContinue" text="保存并继续" onclick="forSaveContinue()"></bsp:containbutton>
...
function forSave(){
  if(!checkMenuSysItem()) return;	
  document.forms[0].action ="menusysitem.cmd?method=insert";
  document.forms[0].submit();	
}
function forSaveContinue(){
  if(!checkMenuSysItem()) return;
  document.forms[0].action ="menusysitem.cmd?method=insertContinue";
  document.forms[0].submit();	
}
function forReturn(){
