...
function checkPubApp(){
	...
	if(trim(tp.value)!="http"&&trim(tp.value)!="https"){
...
<bsp:container title="主机和应用映射表修改" >
<bsp:containbutton action="pubapp.cmd?method=update" text="保存" onclick="forSave()"></bsp:containbutton>
...
<div align="center">
  <table width="100%" cellpadding="0" class="tblContent">
                    ...
                    <td class="tdRight"><html:text name="tp" property="tp" size="15" maxlength="30" /><FONT COLOR=#ff0000>* 例如：http、https等</FONT></td>
                    </tr>                     
					<tr>
...
function forSave(){
  ...
  document.forms[0].action ="pubapp.cmd?method=update";
