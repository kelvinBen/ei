...
<table width="100%" height="400">
    <tr>
      <td width="65%">
		<tree:selTree treeName="seltree" containId="SrcDiv" isShowElseBranch="true" hasRoot="false" type="radio" style="width:100%;height:400;overflow:auto;white-space:nowrap;" isDataAsync="false">
...
<script lanuage="javascript">
	seltree.clickImg=function(node){
		seltree.xmlsrc="menuhelp.cmd?method=getNode&ID="+node.NodeId;
	}
