    ...
    <tr>
      <td width="65%">
		<tree:selTree treeName="seltree" containId="SrcDiv" isShowElseBranch="true" hasRoot="false" type="radio" style="width:300;height:100%;overflow:auto;white-space:nowrap;" isDataAsync="false">
	  		<tree:selNode title="text" nodeId="id" collection="tree" radioData="id" nodeXmlSrc="isTreeLeaf" perImgSrc="perImgSrc"/>
        </tree:selTree>
      </td>
   </tr>
   	<tr>
...
var except="<%=except%>";
	...
	seltree.clickImg=function(node){
		seltree.xmlsrc="menuhelp.cmd?method=children&ID="+node.NodeId+"&except="+except;
	}
