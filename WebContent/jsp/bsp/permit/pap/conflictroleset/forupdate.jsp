...
<bsp:container title="不相容角色集修改" >
<bsp:containbutton text="保存" onclick="forSave()" action="conflictRoleSet.cmd?method=update"></bsp:containbutton>
...
function forSave()
{
    ...
    document.forms[0].action ="conflictRoleSet.cmd?method=update";    
