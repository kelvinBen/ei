...
{     
  ...
  seltree.xmlsrc="function.cmd?method=getTransferNode&objectId="+node.NodeId;   
}
...
function showcheckdata(){
    ...
    returnV[0]="function.cmd?method=transfer&functionId=<%=request.getAttribute("functionId")%>&toModuleId="+seltree.GetAllCheckNodeId();
