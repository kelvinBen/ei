...
<table width="100%" height="400">
	...
	<tree:selTree treeName="seltree" containId="SrcDiv" isShowElseBranch="true" type="radio" hasRoot="false"  style="width:100%;height:400;overflow:auto;white-space:nowrap;" isDataAsync="false">
	  	<tree:selNode title="objectName" nodeId="objectId" nodeValue="nodeValue" collection="functree" nodeXmlSrc="isLeaf" radioData="CheckData" isChecked="isChecked" caption="">
	    </tree:selNode>
	</tree:selTree>
	</td>
    </tr>
