...
<%
//String toUserId = (String)request.getAttribute("toId");//数据权限要被复制到的用户
    ...
    <tr>
      <td>
		<tree:selTree treeName="seltree" containId="SrcDiv"  isShowElseBranch="false"  type="radio" hasRoot="false" rootText="用户列表" style="width:100%;height:400;overflow:auto;white-space:nowrap;">
		  	<tree:selNode title="OBJECTNAME" nodeId="OBJECTID" nodeValue="OBJECTNAME" collection="user_tree" nodeXmlSrc="isLeaf" perImgSrc="perImgSrc" radioData="RadioData" caption="">
		    </tree:selNode>
		</tree:selTree>
	  </td>
    </tr>
...
seltree.clickImg=function(node)
{
 if(node.NodeValue!=null){
    ...
    if(arr[1]=="S")
    {
       seltree.xmlsrc="user.cmd?method=getchoicenode&OBJECTID="+arr[0];    
    }else if(arr[1]=="N"){
       return;
    }
    }    
