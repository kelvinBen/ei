...
function check(){
    ...
    if(document.forms[0].pswd1.value==document.forms[0].oldPassword.value) {
...
<bsp:container title="重置密码" >
<bsp:containbutton text="确定" onclick="forSave()" action ="user.cmd?method=resetUserPassword"></bsp:containbutton>
<html:messages/>
...
<script language="javascript">
  ...
  function forSave(){
    if(!check()) return; 	
       document.forms[0].action ="user.cmd?method=resetUserPassword";    
