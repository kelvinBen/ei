...
<bsp:container title="数据资源类型增加" >
<bsp:containbutton text="保存" onclick="forSave()" action ="datarestype.cmd?method=insert"></bsp:containbutton>
<bsp:containbutton text="保存并继续" onclick="forSaveContinue()" action ="datarestype.cmd?method=insertContinue"></bsp:containbutton>
...
<div align="center">
  <table width="100%" cellpadding="0" class="tblContent">  
                    ...
                    <td class="tdRight"><html:text name="dataResType" property="dataResType" size="10" maxlength="10" /><FONT COLOR=#ff0000>*</FONT></td>
                    </tr>                    
                     <tr>
...
function forSave(){
  ...
  document.forms[0].action ="datarestype.cmd?method=insert";
  document.forms[0].submit();	
}
function forSaveContinue(){
  if(!checkPubDataResType()) return;
  document.forms[0].action ="datarestype.cmd?method=insertContinue";
  document.forms[0].submit();	
}
function forReturn(){
