...
<%
	...
	String url = "resourcequery.cmd?method=query&functionId="
			+ functionId;
...
<html:form name="frmList" action="">
	<bsp:container title="资源增加">
		<bsp:containbutton text="保存" onclick="forSave()"
			action="resources.cmd?method=insert"></bsp:containbutton>
		<bsp:containbutton text="取消" onclick="forCancel()"></bsp:containbutton>
		...
		<table width="100%" cellpadding="0" class="tblContent">
			...
			<tr>
				...
				<td class="tdRight"><html:text name="resourceId"
					property="resourceId" size="30" maxlength="30" /><FONT
			...
			<tr>
				...
				<td class="tdRight"><html:text name="resourceName"
					property="resourceName" size="30" maxlength="30" /><FONT
					COLOR=#ff0000>*</FONT></td>
			</tr>
			...
			<tr>
				...
				<td class="tdRight"><html:text name="resourceAlias"
					property="resourceAlias" size="40" maxlength="60" /><FONT
					COLOR=#ff0000>*</FONT></td>
			</tr>
			...
			<tr>
				...
				<td class="tdRight"><html:select name="resTypeId"
					property="resTypeId">
					<html:options collection="resTypeCollection"
						labelProperty="RES_TYPE_NAME" property="RES_TYPE_ID" />
				</html:select></td>
			</tr>
			...
			<tr>
				...
				<td class="tdRight"><html:textarea name="urlNames"
					property="urlNames" cols="40" /><FONT COLOR=#ff0000>*</FONT></td>
			</tr>
			...
			<tr>
				...
				<td class="tdRight"><html:select name="securityLevel"
					property="securityLevel">
					<html:options collection="PUBRESOURCES_SECURITYLEVEL_COLLECTION"
						labelProperty="LEVEL_NAME" property="SECURITY_LEVEL" />
				</html:select></td>
			</tr>
			...
			<tr>
				...
				<td class="tdRight"><html:checkbox name="isDefault"
					property="isDefault" value="1" /></td>
			</tr>
			...
			<tr>
				...
				<td class="tdRight"><html:checkbox name="isAudit"
					property="isAudit" value="1" /></td>
			</tr>
...
function forSave(){
  ...
  document.forms[0].action="resources.cmd?method=insert&functionId="+"<%=functionId%>"+"&refreshId="+"<%=refreshId%>";	
