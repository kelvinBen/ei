...
<bsp:container title="国家(地区)代码修改" >
<bsp:containbutton text="保存" onclick="forSave()" action="country.cmd?method=update"></bsp:containbutton>
...
function forSave(){
  ...
  document.forms[0].action ="country.cmd?method=update";
