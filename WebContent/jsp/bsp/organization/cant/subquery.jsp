...
<html:form name="frmList" action="cantquery.cmd?method=query">
...
<html:hidden name="superCode" value="<%=superCode%>"/>
<html:hidden name="country" value="<%=country%>"/>
<support:flexgrid name="grid" height="340"  action="" isSubmit="true">
   ...
   <flex:flexCol caption='<%=ResourcesFactory.getString("PUB_CANT.CANT_CODE")%>' width="100" property="cantCode" style="text-align:left" sortName="PUB_CANT.CANT_CODE" onclick="clickCant(this)" style="cursor:hand;color: #000000; text-decoration: underline"></flex:flexCol>
