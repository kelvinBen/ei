...
var workplaceId = document.forms[0].workplaceId;
 var workplaceCode = document.forms[0].workplaceCode;
  ...
  if (trim(workplaceCode.value)=="")
  {
	workplaceCode.value = workplaceId.value;
  }
  workplaceCode.value = trim(workplaceCode.value) ;
  var rs = /^([0-9]|[a-z]|[A-Z])+$/;
  if(!rs.test(workplaceCode.value)){
 ...
 var workplaceName = document.forms[0].workplaceName;
  ...
  if(trim(postCode.value)!=""){
    ...
    //该处上海邮政曾经要求改成6位邮政编码的判断，但是该种要求如果有海外分公司的工作地点的话可能
    //就不合适了，因此该处没有加上这样的校验  
...
<bsp:container title="工作地点修改" >
<bsp:containbutton text="保存" onclick="forSave()" action="workplace.cmd?method=update"></bsp:containbutton>
...
<div align="center">
  <table width="100%" cellpadding="0" class="tblContent">
                    ...
                    <td class="tdRight"><html:text name="workplaceCode" property="workplaceCode" size="30" maxlength="30"/><FONT COLOR=#ff0000>(值为空时,系统自动生成)</FONT></td>
                    </tr>
                    <tr>
                    <td class="tdTitle"><%=ResourcesFactory.getString("PUB_WORKPLACE.WORKPLACE_NAME")%>：</td>
                    <td class="tdRight"><html:text name="workplaceName" property="workplaceName" size="40" maxlength="100"/><FONT COLOR=#ff0000>*</FONT></td>
                    </tr>
                    <tr>
                    <td class="tdTitle"><%=ResourcesFactory.getString("PUB_WORKPLACE.SHORT_NAME")%>：</td>
                    <td class="tdRight"><html:text name="shortName" property="shortName" size="30" maxlength="30"/><FONT COLOR=#ff0000>*</FONT></td>
                    </tr>
                     <tr>
                    <td class="tdTitle"><%=ResourcesFactory.getString("PUB_WORKPLACE.CANT_CODE")%>：</td>
                    <td class="tdRight">
                    <html:hidden name="cantCode" property="cantCode" write="false"/><html:text name="cantName" property="cantName" size="20" maxlength="60"  readonly="true" ondblclick="clean()"/> <FONT COLOR=#ff0000>*</FONT><img src="skins/default/images/liulan.gif" width="28" style="cursor:hand" height="16" border="0" onclick="selectCant()">
                    </td>
                    </tr>
                     <tr>
                    <td class="tdTitle"><%=ResourcesFactory.getString("PUB_WORKPLACE.LINKMAN")%>：</td>
                    <td class="tdRight"><html:text name="linkman" property="linkman" size="50" maxlength="120"/></td>
                    </tr>
                                                             <tr>
                    <td class="tdTitle"><%=ResourcesFactory.getString("PUB_WORKPLACE.TEL")%>：</td>
                    <td class="tdRight"><html:text name="tel" property="tel" size="40" maxlength="80"/></td>
                    </tr>
                                                             <tr>
                    <td class="tdTitle"><%=ResourcesFactory.getString("PUB_WORKPLACE.FAX")%>：</td>
                    <td class="tdRight"><html:text name="fax" property="fax" size="40" maxlength="80"/></td>
                    </tr>
                                                             <tr>
                    <td class="tdTitle"><%=ResourcesFactory.getString("PUB_WORKPLACE.E_MAIL")%>：</td>
                    <td class="tdRight"><html:text name="email" property="email" size="40" maxlength="80"/></td>
                    </tr>
                                                             <tr>
                    <td class="tdTitle"><%=ResourcesFactory.getString("PUB_WORKPLACE.WWW")%>：</td>
                    <td class="tdRight"><html:text name="www" property="www" size="50" maxlength="250"/></td>
                    </tr>
                                                             <tr>
                    <td class="tdTitle"><%=ResourcesFactory.getString("PUB_WORKPLACE.POST_CODE")%>：</td>
                    <td class="tdRight"><html:text name="postCode" property="postCode" size="20" maxlength="20"/></td>
                    </tr>
                                                             <tr>
                    <td class="tdTitle"><%=ResourcesFactory.getString("PUB_WORKPLACE.POST_ADDRESS")%>：</td>
                    <td class="tdRight"><html:text name="postAddress" property="postAddress" size="50" maxlength="250"/></td>
                    </tr>
                                                             <tr>
                    <td class="tdTitle"><%=ResourcesFactory.getString("PUB_WORKPLACE.ENGLISH_ADDRESS")%>：</td>
                    <td class="tdRight"><html:text name="englishAddress" property="englishAddress" size="50" maxlength="250"/></td>
                    </tr>
                                                             <tr>
                    <td class="tdTitle"><%=ResourcesFactory.getString("PUB_WORKPLACE.AM_START_TIME")%>：</td>
                    <td class="tdRight"><html:text name="amStartTime" property="amStartTime" size="8" maxlength="8"/><FONT COLOR=#ff0000>*(格式00:00:00)</FONT></td>
                    </tr>
                                                             <tr>
                    <td class="tdTitle"><%=ResourcesFactory.getString("PUB_WORKPLACE.AM_END_TIME")%>：</td>
                    <td class="tdRight"><html:text name="amEndTime" property="amEndTime" size="8" maxlength="8"/><FONT COLOR=#ff0000>*(格式00:00:00)</FONT></td>
                    </tr>
                                                             <tr>
                    <td class="tdTitle"><%=ResourcesFactory.getString("PUB_WORKPLACE.PM_START_TIME")%>：</td>
                    <td class="tdRight"><html:text name="pmStartTime" property="pmStartTime" size="8" maxlength="8"/><FONT COLOR=#ff0000>*(格式00:00:00)</FONT></td>
                    </tr>
                                                             <tr>
                    <td class="tdTitle"><%=ResourcesFactory.getString("PUB_WORKPLACE.PM_END_TIME")%>：</td>
                    <td class="tdRight"><html:text name="pmEndTime" property="pmEndTime" size="8" maxlength="8"/><FONT COLOR=#ff0000>*(格式00:00:00)</FONT></td>
                    </tr>
     </table>
</div>
</bsp:container>
...
function forSave(){
  ...
  document.forms[0].action ="workplace.cmd?method=update";
