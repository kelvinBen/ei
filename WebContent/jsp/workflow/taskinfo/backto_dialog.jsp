...
<br><fieldset class="FieldsetCss">
	<table width="100%" cellpadding="0" class="tblContent">
		...
		<tr>
		<td align=center>
			<select name="leftOpts"  size="10"  style="width:100" multiple="multiple" ondblclick="moveRight()">
			</select>	
		</td>
		<td align=center>
		...
		<td align=center>
		<select name="rightOpts"  size="10"  style="width:100" multiple="multiple" ondblclick="moveLeft()">
		</select>	
		</td>		
		</tr> 			
		</table>	
