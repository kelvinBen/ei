	 ...
	 <%		
		...
		if(reserveM!=null){
	 	...
	 	if(fieldid.equals("FLD_ESTIMATE_CURRENCY")){
			...
			%>    					  
     	<flex:flexCol caption='发起人' width="100" property="RESOURCE_REQ_NAME" sortName="p.RESOURCE_REQ_NAME"></flex:flexCol>
     	<flex:flexCol caption='发起时间' width="150" property="STARTED_TIME" sortName="p.STARTED_TIME"></flex:flexCol>
     	
     	<flex:flexCol caption='结束时间' width="150" property="LAST_STATE_TIME" sortName="p.LAST_STATE_TIME" ></flex:flexCol>
</support:flexgrid>
...
<flex:pagePolit action="finishtaskinfoquery.cmd">
</flex:pagePolit>
</html:form>
</body>
</html>
...
function exportExcel(){
	...
	if (procDefId == "Package_78a048534f0_Wor1" ){
		document.forms[0].action="headTaskInfo.cmd?method=exportYiBanExcel";
	}else if(procDefId == "Package_d710071985_Wor1"){
		document.forms[0].action="localTaskInfo.cmd?method=exportYiBanExcel";
	}
...
function forsearch(){
	...
	//	}
	//}
	document.forms[0].action="finishtaskinfoquery.cmd";
	document.forms[0].submit();	
}
</script>
