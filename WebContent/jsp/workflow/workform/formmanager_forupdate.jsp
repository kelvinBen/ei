...
var SAVEFLAGINFORMEDITOR=false;
function window_onbeforeunload()
{
if(!SAVEFLAGINFORMEDITOR)
	{
	event.returnValue="您没有保存，刚才的修改将丢失！";
	}
}
</script>
...
<BODY topmargin="10px" onLoad="setTitleInTreeBar('工作流程－流程管理－修改表单');initFormEditor(1);"  onbeforeunload="window_onbeforeunload()" >
...
<tr>
	<td colspan="2">
	<iframe name="formEditor" frameborder="1" marginheight="0" marginwidth="0" scrolling="no"  width="100%" height="100%" src="<%=request.getContextPath()%>/jsp/workflow/resource/formeditor/Mbtool.html">
	</td>
</tr>
</table>
