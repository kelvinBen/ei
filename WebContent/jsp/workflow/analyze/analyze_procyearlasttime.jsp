...
<table id="tblSearch">
	 ...
	 <tr>
       <td nowrap>年份:
			<BUTTON onclick="doPro()" style="width:20px"><<</BUTTON><%=year%>
...
<div align=center>
<graph:chart title="流程持续时间" type="column3d" width="100%" height="100%"  displayTitle="true" defaultRow="1" newLine="true" newLine="true" graphTitle="value" markPosition="top" xxName="月份" yyName="<%=yyName%>" markXy="true">
<graph:data seriesTitle="MONTH"  collection="lastTimeData" itemTitle="itemTitle" itemValue="AVG_LAST_TIME">
</graph:data>
</graph:chart>	
</div>
</html:form>
...
function forSearch(){
		...
		document.forms[0].action="wflasttime.cmd?method=processLastTimeByYear";
