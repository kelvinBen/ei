...
{
       seltree.xmlsrc="wf_struhelp.cmd?method=getChoiceNode&parentId="+node.NodeId+"&reqtype=<%=type%>";       
}
...
function showcheckdata(){
	 ...
	 val["display-url"]='<%=MatrixHref.getUrl("Employee")%>'+seltree.GetAllCheckData();
	 result[0]=val;	 
