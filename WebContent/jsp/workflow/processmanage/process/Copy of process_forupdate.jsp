...
<html:button name="载入流程" value="载入流程" onclick="forLoad()"></html:button>&nbsp;
<html:button name="保存" value="保存" onclick="forSave()"></html:button>&nbsp;
<!--<html:button name="保存为新版本" value="保存为新版本" onclick="forSaveNewVer()"></html:button>&nbsp;-->
...
<INPUT type="hidden" name="xmlcontent" value="">
	...
	<table width="100%" height="95%" cellpadding="0" cellspacing="0" class="tblContent">                                      
		<tr>
			<td colspan="2">
			<%
			//String cbpath=url+"jsp/workflow/processmanage/appletjar/newjar/";// jar 路径
			...
			%>
				...
				<OBJECT classid="clsid:8AD9C840-044E-11D1-B3E9-00805F499D93" name="myApplet" width="100%" height="100%" align="middle" codebase="http://java.sun.com/update/1.5.0/jinstall-1_5-windows-i586.cab#Version=5,0,0,5">
					<PARAM name="java_code" value="com.ntmast.workflow.client.WfD.class">
					<PARAM name="java_archive" value="wfd.jar,wfdform.jar,wfdform-dcwork.jar,dcworkFormData.jar,definedFormdata.jar,wfd-jspform.jar,jspFormsManage.jarwfddefinedform.jar">
					<PARAM NAME="cache_archive" VALUE="xsdbean.jar,commons-collections.jar,wfd.jar,wfdform.jar,wfmanage.jar,workform.jar,xbean.jar,wfd-jspform.jar,jspFormsManage.jar,xercesImpl.jar,WfDSystemConfig.jar,picocontainer.jar,nanocontainer.jar,menu.jar,jgraph.jar,commons-util.jar,bsh.jar,jsr173_1.0_api.jar,javolution.jar,wfdform-dcwork.jar,dcworkFormData.jar,definedFormdata.jar,wfddefinedform.jar">
...
function forSaveNewVer(){
	if(!saveNewVersion(0)) return;
	document.forms[0].action ="process.cmd?method=updateNewVer";
	document.forms[0].submit();	
}
function forSaveAs(){
