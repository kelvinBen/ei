...
<html:form name="frmList" action="jspFormsHelpQuery.cmd">
...
<flex:flexgrid name="grid" height="200" action="" isSubmit="true">
				...
				<flex:flexCol caption='表单ID' width="100" property="id" sortName="jsp.id"></flex:flexCol>
				<flex:flexCol caption='表单名称' width="100" property="name" sortName="jsp.name"></flex:flexCol>
</flex:flexgrid>
<div align=center>
<table width=170><tr>
