...
var nowSeconds=this.getSeconds();
...
if(nowSeconds!=null)
	{
	nowSeconds=this.numUtil(nowSeconds);
	fomatstr=fomatstr.replace("ss",nowSeconds);
	}	
...
var targetFormatDate="yyyy-MM-dd";//转换的日期格式
var targetFormat="yyyy-MM-dd HH:mm:ss";//转换的日期时间格式
...
//alert(ndate.format(targetFormat));
return(ndate.format(targetFormatDate));
