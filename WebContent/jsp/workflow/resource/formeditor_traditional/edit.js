...
{
	if (!WBTB_validateMode())	return;
	var arr = showModalDialog("wbTextBox/table.html", "", "dialogWidth:18.5em; dialogHeight:16.5em; status:0; help:0");
...
{
	var arr = showModalDialog("wbTextBox/swf.htm", "", "dialogWidth:15.5em; dialogHeight:13em; status:0; help:0");
	...
	if (arr != null){
		...
		col=ss[2];
		var string;
        string="<div align='center'><div style='width:640;text-align:left'><a href="+path+">[全屏查看]</a></div><object classid='clsid:D27CDB6E-AE6D-11cf-96B8-444553540000'  codebase='/dcwork/plugin/DCworkPlugIn.exe#version=8,0,22,0' width="+row+" height="+col+"><param name=movie value="+path+"><param name=quality value=high><embed src="+path+" type='application/x-shockwave-flash' width="+row+" height="+col+"></embed></object>"
		content=WBTB_Composition.document.body.innerHTML;
		content=content+string;
		WBTB_Composition.document.body.innerHTML=content;
	}
