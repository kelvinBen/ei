...
<BODY topmargin="10px">
<widgets:container title="模型同步成功" >

<tab:tab  id="tab1" type="table">
	<tab:card text="成功同步的窗口模型" id="mofwindows">
		<table width="100%" cellpadding="0" class="tblContent" style="border:1px solid #000000">
		<tr>
			<td class="tdTitle" style="text-align:left" colspan="4">以下窗口模型已经成功同步：</td>
		</tr>
	...
	<tab:card text="错误信息" id="errormessages">
		<table width="100%" cellpadding="0" class="tblContent" style="border:1px solid #000000">
		<tr>
			<td class="tdTitle" style="text-align:left" colspan="4">以下窗口模型同步时出现错误，无法同步：</td>
		</tr>
		<%
	...
	<tab:card text="警告信息" id="warningmessages">
		<table width="100%" cellpadding="0" class="tblContent" style="border:1px solid #000000">
		<tr>
			<td class="tdTitle" style="text-align:left" colspan="4">以下窗口模型同步时有警告信息：</td>
		</tr>
		<%
			if (warningMsg != null) {
