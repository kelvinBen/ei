...
<div align="center">
  <table width="100%" cellpadding="0" class="tblContent">
	...
	<td class="tdRight"><html:textarea name="description" property="description" cols="80" rows="4" /></td>
	</tr>       
	<tr>
	<td class="tdTitle"><%=ResourcesFactory.getString("MOF_FIELD.MOF_COLUMN_ID")%>：</td>
	<td class="tdRight">
	<html:select name="mofColumnId" property="mofColumnId" >
	<html:options collection="MOFCOLUMN_BYTABID_COLLECTION" labelProperty="NAME" property="MOF_COLUMN_ID" />
	</html:select>
	</td>
	</tr>
	<tr>
	...
	<td class="tdRight"><html:textarea name="displaylogic" property="displaylogic" cols="80" rows="4"/></td>
	</tr>                    
	<tr>
...
function forSave(){
  ...
  document.forms[0].action ="moffield.cmd?method=update";
