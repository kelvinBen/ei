...
function fillsel()
{
	...
	f.src = "multiselect.cmd?method=getRefValueByRefId&mofReferenceName="
	+document.all("mofReferenceId").options[document.all("mofReferenceId").selectedIndex].innerText
	+"&defaultValue="+document.all("random").value;
}
...
function forSave(){
  ...
  document.forms[0].action ="mofcolumn.cmd?method=update";
