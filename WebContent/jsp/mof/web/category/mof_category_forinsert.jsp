...
<widgets:container title="类别管理增加" >
...
<div align="center">
  <table width="100%" cellpadding="0" class="tblContent">  
                    ...
                    <td class="tdRight"><html:text name="parent" property="parent" size="32" maxlength="40" value="<%=parent%>" readonly="true"/><font color="#FF0000"> *</font></td>
                    </tr> 
                    <tr>
                    <td class="tdTitle"><%=ResourcesFactory.getString("MOF_CATEGORY.TYPE")%>：</td>
                    <td class="tdRight"><html:text name="type" property="type" size="32" maxlength="10" value="C"/><font color="#FF0000"> *</font></td>
                    </tr>        
					<tr>
...
function forSave(){
  ...
  document.forms[0].action ="mofcategory.cmd?method=insert";
  document.forms[0].submit();	
}
function forSaveContinue(){
  if(!checkMofCategory()) return;
  document.forms[0].action ="mofcategory.cmd?method=insertContinue";
  document.forms[0].submit();	
}
function forReturn(){
