...
<flex:flexgrid name="grid" height="<%=gridHeight%>" action="pubcommonhelpmoretablesqlgrid.cmd" isSubmit="true">
	<%
	...
	%>
           ...
           <flex:radioCol caption="选择" width="40"  property="<%=idField%>"  name="primaryKey" sortName="<%=key_sort_name%>" canSort="false"></flex:radioCol>
...
if(or==null || or.tagName!="INPUT")
	return;
var arrobj=document.all(or.name);
