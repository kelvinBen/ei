...
<bsp:containbutton action="mofversion.cmd?method=insertcategory" text="保存" onclick="forSave()"></bsp:containbutton>
...
<div align="center">
  <table width="100%" cellpadding="0" class="tblContent">  
					...
					<input type="hidden" name="processPKs" value='<%=request.getAttribute("processPKs")%>'>                                    
  </table>
</div>
</bsp:container>
</html:form>
...
function forSave(){
  ...
  document.forms[0].action ="mofprocessversion.cmd?method=insertprocess";
