...
<DIV id=divContent
	style="FONT-SIZE: 16px; WIDTH: 94%; LINE-HEIGHT: 32px; TEXT-ALIGN: left"></DIV>
</DIV>
<DIV class=noprint
	style="MARGIN-TOP: 20px; WIDTH: 100%; TEXT-ALIGN: center">
<DIV><INPUT style="FONT-SIZE: 17px" onclick=printT() type=button
	value="打 印"> <INPUT style="FONT-SIZE: 17px"
	onclick=window.close(); type=button value="关 闭"></DIV>
</DIV>
</DIV>
</DIV>
</BODY>
