...
//保存查询条件
	...
	sbs.append("<chart xAxisName='办理结果统计' yAxisName='办理结果统计：件' formatNumberScale='0' shownames='1' ");
	...
	List des= e.getValueDescsList("PROPOSALREPLY.TYPE2");
	String data="";
	...
	String sum = "0";
		for(int j=0;j<list.size();j++){		
			...
			String SATISFY=(String)map.get("RETYPE");
			if(key.getKey().equals(SATISFY)){
				sum = (String)map.get("SUM");
				break;
			}
		}	
	sbs.append("<set value='"+sum+"' label='"+key.getValue()+" : "+sum+"件' />");
	}	 
...
<bsp:container title="办复结果统计" >

<html:messages></html:messages>
<html:form name="frmList" action="proposalstatisticquery_page_init.cmd?flag=2">
<table id="tblSearch">
	<tr>
 	...
 	<td>
 	<flex:searchImg name="chaxun" action="proposalstatisticquery_page_init.cmd?flag=2" image="search.gif"/></td>
                    ...
                    <tr>
                     ...
                     <div id="chartdiv" align="center"> </div>
					     		<script type="text/javascript">
						   			var chart = new FusionCharts("<%=app%>/Charts/Doughnut3D.swf", "ChartId", "100%", "380", "0", "0");
