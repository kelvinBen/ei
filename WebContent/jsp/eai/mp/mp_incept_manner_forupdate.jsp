...
<bsp:container title="订阅/接收方式修改" >
<bsp:containbutton action="mpinceptmanner.cmd?method=update" text="保存" onclick="forSave()"></bsp:containbutton>
...
function forSave(){
  ...
  document.forms[0].action ="mpinceptmanner.cmd?method=update";
