...
<bsp:container title="消息订阅列表增加" >
<bsp:containbutton action="mpsubscrlist.cmd?method=insert" text="保存" onclick="forSave()"></bsp:containbutton>
<bsp:containbutton action="mpsubscrlist.cmd?method=insertContinue" text="保存并继续" onclick="forSaveContinue()"></bsp:containbutton>
...
<div align="center">
  <table width="100%" cellpadding="0" class="tblContent">  
                    ...
                    <td class="tdRight"><html:text name="subscrId" property="subscrId" size="30" maxlength="30" /></td>
                    </tr>                    
					<tr>
...
function forSave(){
  ...
  document.forms[0].action ="mpsubscrlist.cmd?method=insert";
  document.forms[0].submit();	
}
function forSaveContinue(){
  if(!checkMpSubscrList()) return;
  document.forms[0].action ="mpsubscrlist.cmd?method=insertContinue";
  document.forms[0].submit();	
}
function forReturn(){
