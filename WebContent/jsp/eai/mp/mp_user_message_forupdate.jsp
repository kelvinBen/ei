...
<bsp:container title="用户消息修改" >
<bsp:containbutton action="mpusermessage.cmd?method=update" text="保存" onclick="forSave()"></bsp:containbutton>
...
function forSave(){
  ...
  document.forms[0].action ="mpusermessage.cmd?method=update";
