...
<% 
  ...
  Map m= WorkflowActionUtil.jump(processId,activityId,userId,nextActDefId,nextActivityUserIdlist,nextActivityUserNamelist,sourceReferenceId,formId,new HashMap());
out.print("发送成功："+m);
