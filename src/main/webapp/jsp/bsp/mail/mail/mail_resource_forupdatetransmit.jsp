...
<span id="message"><html:messages/></span>
	<bsp:containbutton onclick="forSend()" name="btn_send_mail" text="发送" ></bsp:containbutton>
...
function forSend(){
  ...
  if(mailSt==null)
  	document.forms[0].action ="mailresource.cmd?method=sendTransmit";
  else
  	document.forms[0].action ="mailresource.cmd?method=sendTransmit&mailStatus=0";
...
function forUpdate(){
  ...
  var mailSt=<%=mailStatus%>;
  if(mailSt==null)
  	document.forms[0].action ="mailresource.cmd?method=saveTransmit";
  else
  	document.forms[0].action ="mailresource.cmd?method=saveTransmit&mailStatus=0";
