...
<bsp:container title="组织参数类型表增加" >
<bsp:containbutton action="organparmst.cmd?method=insert" text="保存" onclick="forSave()"></bsp:containbutton>
<bsp:containbutton action="organparmst.cmd?method=insertContinue" text="保存并继续" onclick="forSaveContinue()"></bsp:containbutton>
...
<div align="center">
  <table width="100%" cellpadding="0" class="tblContent">  
                    ...
                    <td class="tdRight"><html:text name="parmsName" property="parmsName" size="30" maxlength="30" /><FONT COLOR=#ff0000>*</FONT></td>
                    </tr>                    
					<tr>
...
function forSave(){
  ...
  document.forms[0].action ="organparmst.cmd?method=insert";
  document.forms[0].submit();	
}
function forSaveContinue(){
  if(!checkOrganParmsT()) return;
  document.forms[0].action ="organparmst.cmd?method=insertContinue";
  document.forms[0].submit();	
}
function forReturn(){
