...
<table width="100%" height="100%">
    ...
    <tree:selTree treeName="seltree" containId="SrcDiv" isShowElseBranch="false"   hasRoot="false"  style="width:100%;height:400;overflow:auto;white-space:nowrap;" isDataAsync="false">
	  	<tree:selNode title="cantName" nodeId="cantCode" nodeValue="cantCode"  collection="cant_tree" nodeXmlSrc="isLeaf" radioData="cantCode"  caption="">
	    </tree:selNode>
	</tree:selTree>
...
{
       seltree.xmlsrc="cant.cmd?method=getChoiceNode&supercode="+node.NodeId;
}
