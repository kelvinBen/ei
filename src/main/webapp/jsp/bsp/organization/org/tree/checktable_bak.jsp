...
5 树形代码	   <flex:flexCol caption="树形代码" width="200" property="value" style="text-align:left" sortName="stru.value" style="display:none"></flex:flexCol>                           
6 workplace	   <flex:flexCol caption="所属地区" width="100" property="workplace" style="text-align:left" sortName="stru.workplace" ></flex:flexCol>                           
