...
<table width="100%" height="400">
   ...
   <td width="50%" height="100%">
	<tree:selTree treeName="seltree" containId="SrcDiv"  isShowElseBranch="false"  type="checkbox" hasRoot="false" rootText="主菜单" style="width:100%;height:100%;overflow:auto;white-space:nowrap;" isDataAsync="false">
...
{  
	seltree.xmlsrc="menusys.cmd?method=getMenuSysNodeHelp&menuSysId="+node.NodeId+"&isCheckBox=1"+"&isAll="+"<%=isAll%>";
}
...
function showcheckdata(){
	...
	result[0]=seltree.GetAllCheckNodeId();//返回的是menusysId
	result[1]=seltree.GetAllCheckText();//返回的是
