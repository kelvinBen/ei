    ...
    <tr>
      <td>
		<tree:selTree treeName="seltree" containId="SrcDiv"  isShowElseBranch="false"  type="radio" hasRoot="false" rootText="角色列表" style="width:100%;height:400;overflow:auto;white-space:nowrap;">
		  	<tree:selNode title="OBJECTNAME" nodeId="OBJECTID" nodeValue="OBJECTNAME" collection="role_tree" nodeXmlSrc="isLeaf" perImgSrc="perImgSrc" radioData="ChoiceData" caption="">
		    </tree:selNode>
		</tree:selTree>
	  </td>
    </tr>
