...
<table width="100%" height="400">
	...
	<tree:selTree treeName="seltree" containId="SrcDiv"  isShowElseBranch="false" type="checkbox" hasRoot="false" rootText="角色列表" style="width:100%;height:400;overflow:auto;white-space:nowrap;">
	  	<tree:selNode title="roleAlias" nodeId="roleId" nodeValue="roleId" collection="role_tree" nodeXmlSrc="isLeaf" checkData="CheckData" caption="">
	    </tree:selNode>
	</tree:selTree>
	</td>
    </tr>
...
{
        seltree.xmlsrc="role.cmd?method=selectnode";        
}
