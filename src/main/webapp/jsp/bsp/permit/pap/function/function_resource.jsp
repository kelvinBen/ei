...
<html:form action="function.cmd?method=query">
	<table width="100%">
		<flex:search>
           ...
           <html:hidden name="moduleIdForUpdate" value="<%=moduleIdForUpdate%>"/>
			<tr>
				...
				<flex:searchText name="moduleName"
				...
				<img src="skins/default/images/liulan.gif" width="28"
					...
					name="chaxun" action="function.cmd?method=query" image="search.gif" />
				</td>
				<%
...
function onSumit(){
   ...
   document.forms[0].action="roleResource.cmd?method=updateRoleResource";
