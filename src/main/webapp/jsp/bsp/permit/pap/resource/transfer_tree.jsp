...
<%}%>
	...
	<tree:selTree treeName="seltree" containId="SrcDiv" isShowElseBranch="true" type="radio" hasRoot="false"  style="width:100%;height:400;overflow:auto;white-space:nowrap;" isDataAsync="false">
	  	<tree:selNode title="objectName" nodeId="objectId" nodeValue="isLeaf" collection="resourcetree" nodeXmlSrc="isTreeLeaf" caption="" perImgSrc="perImgSrc">
	    </tree:selNode>
	</tree:selTree>
	</td>
    </tr>
...
{     
  ...
  seltree.xmlsrc="resources.cmd?method=getTransferNode&objectId="+node.NodeId;   
}
...
function showcheckdata(){
    ...
    returnV[0]="resources.cmd?method=transfer&resourceId=<%=request.getAttribute("resourceId")%>&tofunctionId="+seltree.GetAllCheckNodeId();
