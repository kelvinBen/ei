...
List checklist=(List)request.getAttribute("checkUserPerList");
%>
<html>
<head>
<title>用户代理检查</title>
...
<bsp:container title="用户代理检查" >

<bsp:containbutton text="修复" action="checkuserCmd.cmd?method=repairUserPer" onclick="forClear()" ></bsp:containbutton>
...
<div align="center" >
		...
		<TR align="CENTER" >
			<Td width="20%" style="font-size:20"><b>公司</b></Td>
			<Td width="20%" style="font-size:20"><b>用户</b></Td>
			<Td width="20%"  style="font-size:20"><b>被代理用户</b></Td>
...
for(int t=0;t<checklist.size();t++){
	...
	out.println("<input type='hidden' name='userId' value="+ (String)map.get("USER_ID") +">");
...
function forClear(){
  ...
  document.forms[0].action ="checkuserCmd.cmd?method=repairUserPer";
