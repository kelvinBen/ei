...
<bsp:container title="字段模型修改" >
<bsp:containbutton action="soafield.cmd?method=update" text="保存" onclick="forSave()"></bsp:containbutton>
...
function forSave(){
  ...
  document.forms[0].action ="soafield.cmd?method=update";
