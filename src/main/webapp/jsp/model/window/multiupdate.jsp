...
<bsp:containbutton action="soawindow.cmd?method=save"  text="保存" onclick="forSave()"></bsp:containbutton>
...
<div>
		<grid:grid name="grid" sumRow="true" headCss="divToucss" detailCss="divTiSkin" sumCss="divSumcss" complexHead="false" property="tabList" type="edit" headHeight="22"  sumHeight="22" width="100%" height="200">		       	
			...
			<grid:textCol property="index" caption="序号" width="90" index="5" xml="index"  name="index" style="width:100%" styleClass="default"></grid:textCol>	
			<grid:selectCol  property="isMain" name="isMain" caption="是否主tab" width="60" index="6" style="width:100%">
				<grid:options collection="SOATAB_ISMAIN_COLLECTION" labelProperty="value" property="key"/>
			</grid:selectCol>
			<grid:selectCol  property="isDetail" name="isDetail" caption="是否明细" width="60" index="7" style="width:100%">
				<grid:options collection="SOATAB_ISDETAIL_COLLECTION" labelProperty="value" property="key"/>
			</grid:selectCol>
			<grid:selectCol  property="isSameTab" name="isSameTab" caption="是否同一tab" width="60" index="8" style="width:100%">
