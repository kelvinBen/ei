...
<bsp:container title="通用选择修改" >
<bsp:containbutton action="pubcomhelp.cmd?method=update" text="保存" onclick="forSave()"></bsp:containbutton>
...
function forSave(){
  ...
  document.forms[0].action ="pubcomhelp.cmd?method=update";
