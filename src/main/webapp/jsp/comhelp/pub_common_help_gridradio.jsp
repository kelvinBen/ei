...
<input type="hidden" name="isCheckBox" value="0"  > 
<table>
<flex:search>
	<tr>
<%
...
<flex:flexgrid name="grid" height="342" action="helpgridquery.cmd" isSubmit="true">
           ...
           <flex:radioCol caption="选择" width="50"  property="<%=PubCommonHelpView.getIdField()%>"  name="primaryKey" sortName=" . " canSort="false"></flex:radioCol>
	 
	   <flex:flexCol caption='返回值数据存放列'  property="RETURN_VALUES"  width="100"  sortName=" . " style="display:none"></flex:flexCol>
	<%
