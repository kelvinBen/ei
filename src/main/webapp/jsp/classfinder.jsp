...
<p><font color="#000000">
Enter the fully-qualified name of a Java class
...
using the following methods: <pre>
Class.forName(className).getProtectionDomain().getCodeSource()
</pre> </font></p>
<form method="post" action="classfinder.jsp">
<p>Class Name: <input type="text" name="classname" value="" size="40" /> <input type="submit" value="Submit" /></p>
</form>
<%
if ((classLocation != null) || (error != null)) {
			...
			out.println("\t\t\t<td><font color=\"#000000\">" + className
					+ "</font></td>");
			out.println("\t\t</tr>");
			out.println("\t\t<tr>");
