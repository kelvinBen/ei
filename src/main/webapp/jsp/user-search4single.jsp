...
$(function(){
	...
	$('#select_new').click(function(){
		window.location.href="<s:url namespace='/user' action='tosearch4single'/>";		
	});
...
<body>
<div class="editdiv">
	<s:form id="list" namespace="/user" action="list4single" theme="simple" method="post"> 
	<table class="tblContent" width="100%" cellpadding="0">
		...
		<table class="tblContent4list" style="table-layout:fixed;word-break:break-all;" cellpadding="0">
	        ...
	        <tr>
	          ...
	          <td><input type="radio" name="ids" value="<s:property value='#user.id'/>" class="ids"/></td>
	        </tr>
	        <script type="text/javascript">
	        	jsonTemp = {};
