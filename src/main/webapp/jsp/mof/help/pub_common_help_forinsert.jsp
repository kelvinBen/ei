...
<widgets:container title="通用帮助增加" >
...
<div align="center">
  <table width="100%" cellpadding="0" class="tblContent">  
                    ...
                    <td class="tdRight"><html:text name="helpId" property="helpId" size="30" maxlength="30" /></td>
                    </tr>                    
                     <tr>
...
function forSave(){
  ...
  document.forms[0].action ="pubcommonhelp.cmd?method=insert";
  document.forms[0].submit();	
}
function forSaveContinue(){
  if(!checkPubCommonHelp()) return;
  document.forms[0].action ="pubcommonhelp.cmd?method=insertContinue";
  document.forms[0].submit();	
}
function forReturn(){
