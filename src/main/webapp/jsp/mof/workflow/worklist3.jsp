...
function doHistory(){
  ...
  var url = "mofexecquery.cmd?window_name=wfqueuelog&workitemId="+workitemId;
...
function openFlow(){
    ...
    var url="taskinfo.cmd?method=displaystatus&processId="+row[11];
