...
<bsp:container title="版本管理增加" >
<bsp:containbutton action="mofversion.cmd?method=insert" text="保存" onclick="forSave()"></bsp:containbutton>
<bsp:containbutton action="mofversion.cmd?method=insertContinue" text="保存并继续" onclick="forSaveContinue()"></bsp:containbutton>
...
<div align="center">
  <table width="100%" cellpadding="0" class="tblContent">  
                    ...
                    <td class="tdRight"><html:text name="version" property="version" size="60" maxlength="60" /></td>
                    </tr>                    
					<tr>
                    ...
                    <td class="tdRight">
                    	<html:select name="versionType" property="versionType" >
	                        <html:options collection="MOFVERSION_VERSIONTYPE_COLLECTION" labelProperty="value" property="key"/>
	                    </html:select>
	                </td>
                    </tr>
					<html:hidden name="versionData" property="versionData" write="false"/>                                      
  </table>
</div>
</bsp:container>
</html:form>
...
function forSave(){
  ...
  if(document.forms[0].versionType.value=="mof")	
  	document.forms[0].action ="mofversion.cmd?method=insert";
  else if(document.forms[0].versionType.value=="mofprocess")
  	document.forms[0].action ="mofprocessversion.cmd?method=insert";
  document.forms[0].submit();	
}
function forSaveContinue(){
  if(!checkMofVersion()) return;
  if(document.forms[0].versionType.value=="mof")	
  	document.forms[0].action ="mofversion.cmd?method=insertContinue";
  else if(document.forms[0].versionType.value=="mofprocess")
  	document.forms[0].action ="mofprocessversion.cmd?method=insertContinue";
  document.forms[0].submit();	
}
function forReturn(){
