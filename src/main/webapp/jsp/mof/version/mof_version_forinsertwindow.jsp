...
<bsp:containbutton action="mofversion.cmd?method=insertwindow" text="保存" onclick="forSave()"></bsp:containbutton>
...
<div align="center">
  <table width="100%" cellpadding="0" class="tblContent">  
					...
					<input type="hidden" name="mofWindowId" value='<%=request.getAttribute("mofWindowId")%>'>                                    
  </table>
</div>
</bsp:container>
</html:form>
...
function forSave(){
  ...
  document.forms[0].action ="mofversion.cmd?method=insertwindow";
