...
<bsp:containbutton action="mofversion.cmd?method=insertall" text="保存" onclick="forSave()"></bsp:containbutton>
...
function forSave(){
  ...
  document.forms[0].action ="mofversion.cmd?method=insertall";
