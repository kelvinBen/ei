...
<script language="javascript">
	...
	function dolistedocsOfType(){
		window.location.href="mofroletaskinfoquery.cmd?processType="+seltree.getValue("NodeId");
	}
	function dolistedocsOfProcess(processType){
		window.location.href="mofroletaskinfoquery.cmd?procDefId="+seltree.getValue("NodeId")+"&processType="+processType;
	}
	function listalledocs(){
		window.location.href="mofroletaskinfoquery.cmd";
	}
</script>
</head>
...
<div><fieldset class="FieldsetCss"><legend>共有<%=request.getAttribute("TOTAL_NUMBER")%>个角色任务</legend>
...
<script lanuage="javascript">
	...
	seltree.clickImg=function(node){
		seltree.xmlsrc="moftaskinforole.cmd?method=getProcessList&TYPE_ID="+node.NodeId;
	}
</script>
