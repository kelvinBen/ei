...
<script language="javascript">
	...
	function dolistedocsOfType(){
		window.location.href="mofoldtaskinfoquery.cmd?processType="+seltree.getValue("NodeId");
	}
	function dolistedocsOfProcess(processType){
		window.location.href="mofoldtaskinfoquery.cmd?procDefId="+seltree.getValue("NodeId")+"&processType="+processType;
	}
	function listalledocs(){
		window.location.href="mofoldtaskinfoquery.cmd";
	}
</script>
</head>
...
<script lanuage="javascript">
	...
	seltree.clickImg=function(node){
		seltree.xmlsrc="moftaskinfoyiban.cmd?method=getProcessList&TYPE_ID="+node.NodeId;
	}
</script>
