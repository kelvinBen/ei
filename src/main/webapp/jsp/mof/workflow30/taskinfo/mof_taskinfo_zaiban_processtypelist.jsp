...
<script language="javascript">
	...
	function dolistedocsOfType(){
		window.location.href="moftaskinfoquery.cmd?processType="+seltree.getValue("NodeId")+"&readMark=1";
	}
	function dolistedocsOfProcess(processType){
		window.location.href="moftaskinfoquery.cmd?procDefId="+seltree.getValue("NodeId")+"&processType="+processType+"&readMark=1";
	}
	function listalledocs(){
		window.location.href="moftaskinfoquery.cmd?readMark=1";
	}
</script>
</head>
...
<script lanuage="javascript">
	...
	seltree.clickImg=function(node){
		...
		seltree.xmlsrc="moftaskinfozaiban.cmd?method=getProcessList&TYPE_ID="+node.NodeId;
