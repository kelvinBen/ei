...
function showcheckdata(){
		...
		var value = new Array();
		value["primary-value"]=seltree.GetAllCheckNodeId();
		value["display-str"]=seltree.GetAllCheckText();
		value["display-url"]='<%=MatrixHref.getUrl("Role")%>'+seltree.GetAllCheckNodeId();
		result[0]=value;
