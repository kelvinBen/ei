...
<script language="javascript">
setTitleInTreeBar('表单打印模板增加');
function forSave(){
  if(!checkFormprinttemplet()) return;	
  saveFile();
  document.forms[0].action ="formprinttemplet.cmd?method=insert";
  document.forms[0].submit();	
}
function forSaveContinue(){
  if(!checkFormprinttemplet()) return;
  document.forms[0].action ="formprinttemplet.cmd?method=insertContinue";
  document.forms[0].submit();	
}
function forReturn(){
