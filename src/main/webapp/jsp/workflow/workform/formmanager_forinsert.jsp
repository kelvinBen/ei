...
%>
<body topmargin="10px" onload="setTitleInTreeBar('工作流程－流程管理－增加表单');initFormEditor(0);"  onbeforeunload="window_onbeforeunload()" >
...
<tr>
	<td colspan="2"><iframe name="formEditor" frameborder="1" 
			marginheight="0" marginwidth="0" scrolling="no"  width="100%" height="100%" src="<%=request.getContextPath()%>/jsp/workflow/resource/formeditor/Mbtool.html">
	</td>
</tr>
</table>
</html:form>
