...
function selectNewDeptIdTree(){
  var url ="struhelp.cmd?method=getSelectRoot&organType=1,2&isCheckBox=0&isIncludeSelf=1&isTree=1&showOrganType=1,2";      
...
function forReturnQuery() {
     window.history.back();	
}
</script>
<BODY topmargin="10px" onLoad="setTitleInTreeBar('工作流程－流程管理－表单明细');initFormEditor();disableForm();">
<div class="btnareaCss">
<html:button onclick="forReturnQuery()" name="btn_return"  value="返回"></html:button>
</div>
...
<tr>
	<td colspan="2">
	<iframe name="formEditor" frameborder="1" marginheight="0" marginwidth="0" scrolling="yes"  width="100%" height="100%" src="<%=request.getContextPath()%>/jsp/workflow/resource/formeditor/Mbtool.html">
	</td>
</tr>
</table>
