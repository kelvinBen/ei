...
<%String year = (String) request.getAttribute("YEAR");
			List list = (List) request.getAttribute("personbyquarter");
			Map map = null;
			...
			request.setAttribute("personbyquarter", retList);
...
<html:form name="frmList" action="">
	...
	<div align=center><graph:chart title="<%=title%>" type="column3d"
		...
		<graph:data seriesTitle="seriesTitle" grpType="grpType"
			collection="personbyquarter" itemTitle="itemTitle"
...
function doPro(){
   document.all("dateMove").value="pro" ;
    document.forms[0].action="wfpersonanlyze.cmd?method=PersonAnalyzeByQuarter";
