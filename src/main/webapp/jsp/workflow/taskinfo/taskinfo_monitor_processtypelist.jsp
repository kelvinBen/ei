...
<script language="javascript">
	...
	function dolistedocsOfType(){
		window.location.href="restaskinfoquery.cmd?clear=true&processType="+seltree.getValue("NodeId")+"&isEdoc="+document.forms[0].isEdoc.value;
	}
	function dolistedocsOfProcess(processType){
		window.location.href="restaskinfoquery.cmd?clear=true&procDefId="+seltree.getValue("NodeId")+"&processType="+processType+"&isEdoc="+document.forms[0].isEdoc.value;;
	}
	function listalledocs(){
		window.location.href="restaskinfoquery.cmd?clear=true&isEdoc="+document.forms[0].isEdoc.value;
	}
</script>
</head>
...
<script lanuage="javascript">
	...
	seltree.clickImg=function(node){
		seltree.xmlsrc="taskinfomonitor.cmd?method=getProcessList&TYPE_ID="+node.NodeId;
	}
</script>
