...
<flex:flexgrid name="grid" height="360" action="" isSubmit="false">
                          ...
                          <flex:flexCol caption='标题' width="100" property="SUBJECT" sortName="SUBJECT.SUBJECT" canSort="false"></flex:flexCol>
                          <flex:flexCol caption='优先级' width="60" property="sysPriority" sortName="WF_TASK_LIST.PRIORITY" canSort="false"></flex:flexCol>
                          <flex:flexCol caption='当前环节' width="100" property="sysActivityName" sortName="WF_TASK_LIST.ACTIVITY_NAME" canSort="false"></flex:flexCol>
                          <flex:flexCol caption='当前处理人' width="100" property="sysUserName" sortName="WF_TASK_LIST.USER_NAME" canSort="false"></flex:flexCol>
                          <flex:flexCol caption='发送环节' width="100" property="sysPreviousActivityName" sortName="WF_TASK_LIST.PREVIOUS_ACTIVITY_NAME" canSort="false"></flex:flexCol>
                          <flex:flexCol caption='发送人' width="100" property="sysPreviousResourceName" sortName="WF_TASK_LIST.PREVIOUS_RESOURCE_NAME" canSort="false"></flex:flexCol>
                          <flex:flexCol caption='发送时间' width="100" property="sysActCreateTime" sortName="WF_TASK_LIST.CREATE_TIME" canSort="false"></flex:flexCol>
                          <flex:flexCol caption='流程名称' width="100" property="sysProcessName" sortName="WF_TASK_LIST.PROCESS_NAME" canSort="false"></flex:flexCol>
                          <flex:flexCol caption='当前状态' width="100" property="sysActCurrentState" sortName="WF_TASK_LIST.ACT_CURRENT_STATE"  type="enum" enumCollection="WF_STATE" enumKey="key" enumValue="value" canSort="false"></flex:flexCol>
                          <flex:flexCol caption='查阅状态' width="100" property="sysReadMark" sortName="WF_TASK_LIST.READ_MARK"  type="enum" enumCollection="WF_TASKINFO_READMARK_COLLECTION" enumKey="key" enumValue="value" canSort="false"></flex:flexCol>
</flex:flexgrid>

</html:form>
<script language="javascript">
setTitleInTreeBar("工作流程－查询管理－表单查询－待办/在办任务");
