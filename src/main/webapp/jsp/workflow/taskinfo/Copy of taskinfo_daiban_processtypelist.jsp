...
seltree.clickImg=function(node){
	seltree.xmlsrc="taskinfodaiban.cmd?method=getProcessList&TYPE_ID="+node.NodeId;
	//seltree.xmlsrc="taskinfodaiban.cmd?method=getProcessListForSender&TYPE_ID="+node.NodeId;//按发送人分组
}
</script>
