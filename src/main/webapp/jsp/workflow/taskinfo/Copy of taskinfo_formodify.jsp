...
<tab:card id="card_forminfo" text='表单111' selected="1">
...
<%}%>
<!-- 
<tab:card id="card_proc_status" text='流转状态'>
<p align="center">
	<table width="100%" height="100%" cellpadding="0" cellspacing="0" class="tblContent"> 
		<tr>
			<td>
				<iframe style="display: block" id="procStatusFrame" width="100%" height="500" frameborder="0"></iframe>
			</td>
		</tr>  
	</table>						
</tab:card>
...
updateActivityUser();
setTitleInTreeBar("工作流程－任务管理－处理任务");
