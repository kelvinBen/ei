...
<support:flexgrid name="grid" height="200" action="" isSubmit="false">
                          ...
                          <flex:flexCol caption='环节ID' width="150" property="sysActivityId" sortName="taskinfo.sysActivityId" style="display:none"></flex:flexCol>
                          ...
                          <flex:flexCol caption='当前处理人' width="100" property="sysResponseName" sortName="taskinfo.sysResponseName"></flex:flexCol>
...
function forold(activity_id,process_id){
	document.forms[0].action ="taskinfo.cmd?method=forold&activityId="+activity_id+"&processId="+process_id;    
