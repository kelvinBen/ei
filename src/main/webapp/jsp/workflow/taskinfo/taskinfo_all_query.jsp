...
String processType = RequestUtil.getAttrOrPara2String(request, "processType");
	...
	String extReturnUrl="alltaskinfoquery.cmd?procDefId="+procDefId+"&processType="+processType+"&organId="+organId+"&isShowReturnBtn="+isShowReturnBtn;
%>

<html:form name="frmList" action="alltaskinfoquery.cmd">
...
%>	
	<td class="tdRight"><flex:searchImg name="chaxun" action="alltaskinfoquery.cmd" image="search.gif"/></td>
	</tr>
...
<flex:pagePolit action="allTaskInfo.cmd?method=queryZaiBan">
</flex:pagePolit>
</html:form>
</body>
</html>
...
function forold(activity_id,process_id,formplugin,curUserId){
//在此进行扩展，实现无表单的处理
...
function forsearch(){
	...
	document.forms[0].action="alltaskinfoquery.cmd";
	document.forms[0].submit();	
}
</script>
