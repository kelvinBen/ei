...
function forReturn(){
	...
	//解冻时间
	result[2]=document.all("resumeDate").value;
	//操作原因
	result[3]=document.forms[0].reason.value;
...
function selEmp(){
  ...
  document.all("activityManagerDis").innerHTML="";
  return ;   
   }
...
<br><fieldset class="FieldsetCss">
	<table width="100%" cellpadding="0" class="tblContent">
		...
		<input type="hidden" name="resumeDate" value="">
		<!--
				<tr>
		<td class="tdLeft">解冻时间：</td>
		<td class="TdRight"><date:date name="resumeDate" zindex="19" hastime="true" divname="resumeDatedd"  sourceFormat="yyyy/MM/dd hh:mm" targetFormat="yyyy/MM/dd hh:mm" readonly="true">
