...
<support:flexgrid name="grid" height="200" action="" isSubmit="false">
                          ...
                          <flex:flexCol caption='环节ID' width="100" property="sysActivityId" sortName="taskinfo.sysActivityId" style="display:none"></flex:flexCol>
                          ...
                          <flex:flexCol caption='当前处理人ID' width="100" property="sysUserId" sortName="taskinfo.sysUserId" style="display:none"></flex:flexCol>
                          <flex:flexCol caption='当前处理人' width="100" property="sysUserName" sortName="taskinfo.sysUserName"></flex:flexCol>
                          <flex:flexCol caption='发送环节' width="150" property="sysPreviousActivityName" sortName="taskinfo.sysPreviousActivityName"></flex:flexCol>
                          <flex:flexCol caption='发送人' width="100" property="sysPreviousResourceName" sortName="taskinfo.sysPreviousResourceName"></flex:flexCol>
                          <flex:flexCol caption='发送时间' width="150" property="sysActCreateTime" sortName="taskinfo.sysActCreateTime"></flex:flexCol>
                          
                          <flex:flexCol caption='当前状态' width="100" property="sysActCurrentState" sortName="taskinfo.sysActCurrentState" style="display:none"></flex:flexCol>
...
for(var i=1;i<grid.returnRowCount()+1;i++){
		...
		var organ_id=grid.getCellValue(i,5);
...
function forDeal(activity_id,process_id,organ_id){
	//alert(document.all("EXT_RETURN_URL").value);
  document.forms[0].action ="taskinfo.cmd?method=fordeal&activityId="+activity_id+"&processId="+process_id+"&sysOrganId="+organ_id;    
