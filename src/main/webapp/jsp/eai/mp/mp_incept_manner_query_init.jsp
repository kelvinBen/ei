...
%>
<bsp:container title="订阅方式查看" >
<bsp:containbutton action="mpinceptmanner.cmd?method=detail" onclick="forDetail()" text="明细"></bsp:containbutton>
<html:messages></html:messages>
<html:form name="frmList" action="mpinceptmannerquery_page_init.cmd">
<table id="tblSearch">
<flex:search>
	<tr>
    <td>订阅方式名称：<flex:searchText name="receive_manner_nameSearch" searchName="MP_INCEPT_MANNER.RECEIVE_MANNER_NAME" dataType="java.lang.String" operSymbol="=" value="<%=receive_manner_name%>" size="12">
	</flex:searchText></td>
...
<flex:flexgrid name="grid" height="250" action="" isSubmit="true">
				<flex:checkboxCol caption='选择' width="60" property="receiveMannerCode" name="primaryKey" sortName="MP_INCEPT_MANNER.RECEIVE_MANNER_CODE" ></flex:checkboxCol>
