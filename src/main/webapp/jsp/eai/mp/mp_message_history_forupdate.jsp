...
<bsp:container title="历史消息修改" >
<bsp:containbutton action="mpmessagehistory.cmd?method=update" text="保存" onclick="forSave()"></bsp:containbutton>
...
<div align="center">
  <table width="100%" cellpadding="0" class="tblContent">
                    ...
                    <td class="tdRight"><html:text name="creater" property="createrName" size="30" maxlength="30" />
                    </td>
                    </tr>                    
					<tr>
...
function forSave(){
  ...
  document.forms[0].action ="mpmessagehistory.cmd?method=update";
