...
<bsp:container title="订阅者类型修改" >
<bsp:containbutton action="mpsubscribertype.cmd?method=update" text="保存" onclick="forSave()"></bsp:containbutton>
...
<div align="center">
  <table width="100%" cellpadding="0" class="tblContent">
                    ...
                    <td class="tdRight"><html:text name="subscrTypeCode" property="subscrTypeCode" size="30" maxlength="30" /></td>
                    </tr>                    
					<tr>
                    <td class="tdTitle"><%=ResourcesFactory.getString("MP_SUBSCRIBER_TYPE.SUBSCR_TYPE_NAME")%>：</td>
                    <td class="tdRight"><html:text name="subscrTypeName" property="subscrTypeName" size="30" maxlength="30" /></td>
                    </tr>                    
  </table>
</div>
</bsp:container>
...
function forSave(){
  ...
  document.forms[0].action ="mpsubscribertype.cmd?method=update";
