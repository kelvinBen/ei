...
<bsp:container title="消息类型修改" >
<bsp:containbutton action="mpmessagetype.cmd?method=update" text="保存" onclick="forSave()"></bsp:containbutton>
...
<div align="center">
  <table width="100%" cellpadding="0" class="tblContent">
                    ...
                    <td class="tdRight"><html:hidden name="msgTypeCode" property="msgTypeCode" write="true" /> <FONT COLOR=#ff0000>&nbsp;*</FONT></td>
                    </tr>                    
					<tr>
                    ...
                    <td class="tdRight">
                    <html:radioGroup name="isCommonMsg" property="isCommonMsg" collection="MP_MESSAGE_TYPE_IS_COMMON_MSG" labelProperty="value" labelKey="key"/>
                    </td>
                    </tr>                    
					<tr style="display:none">
...
function forSave(){
  ...
  document.forms[0].action ="mpmessagetype.cmd?method=update";
