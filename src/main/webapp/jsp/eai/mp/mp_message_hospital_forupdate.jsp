...
<bsp:container title="消息错误诊断修改" >
<bsp:containbutton action="mpmessagehospital.cmd?method=update" text="保存" onclick="forSave()"></bsp:containbutton>
