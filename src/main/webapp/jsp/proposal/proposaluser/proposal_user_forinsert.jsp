...
function forSave(){
  ...
  document.forms[0].action ="proposaluser.cmd?method=insert";
  document.forms[0].submit();	
}
function forSaveContinue(){
  if(!checkProposalUser()) return;
  document.forms[0].action ="proposaluser.cmd?method=insertContinue";
  document.forms[0].submit();	
}
function forReturn(){
...
function selectUser(){
  ...
  var cmdUrl="user.cmd&method=getchoiceroot&isIncludeSubCorporation=1&rootId=1";
