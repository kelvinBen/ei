...
<HTML>
<HEAD>
<TITLE><%=ResourcesFactory.getString("ORGAN_STRU.UPDATE.TITLE")%></TITLE>
...
<bsp:container title='<%=ResourcesFactory.getString("ORGAN_STRU.UPDATE.TITLE")%>' >
<bsp:containbutton action="organstru.cmd?method=update" text='<%=ResourcesFactory.getString("COMMON.SAVE")%>' onclick="forSave()"></bsp:containbutton>
<bsp:containbutton text='<%=ResourcesFactory.getString("COMMON.RESET")%>' onclick="forReset()"></bsp:containbutton>
<bsp:containbutton action="organstruquery_page_init.cmd" text='<%=ResourcesFactory.getString("COMMON.BACK")%>' onclick="forReturn()"></bsp:containbutton>
...
<div align="center">
  <table width="100%" cellpadding="0" class="tblContent">
                    ...
                    <td class="tdRight"><html:text name="organId" readonly="true"property="organId" size="30" maxlength="30" /></td>
                    </tr>                    
					<tr>
                    ...
                    <html:text name="principalName" property="principalName"  size="20" maxlength="60"  readonly="true"/>
                    ...
                    <td class="tdRight">
                    <date:date readonly="true" name="endDate" property="endDate" divname="endDatedd"  sourceFormat="yyyyMMdd" targetFormat="yyyyMMdd"></date:date>
                    </td>
                    </tr>
                    <tr>
                    <td class="tdTitle"><%=ResourcesFactory.getString("ORGAN_STRU.STRU_PATH")%>:</td>
                    <td class="tdRight"><html:text name="struPath" property="struPath" size="50" maxlength="50" /></td>
                    </tr>
                    <tr>
                    <td class="tdTitle"><%=ResourcesFactory.getString("ORGAN_STRU.ORGAN_ORDER")%>:</td>
                    <td class="tdRight"><html:text name="organOrder" property="organOrder" size="8" maxlength="8" /></td>
                    </tr> 
                    <tr>
...
function forSave(){
  ...
  document.forms[0].action ="organstru.cmd?method=update";
  document.forms[0].submit();	
}
function forReturn(){
  document.forms[0].action ="organstruquery_page_init.cmd";
  document.forms[0].submit();	
}
function forReset(){  
