...
<HTML>
<HEAD>
<TITLE><%=ResourcesFactory.getString("PRODUCT.UPDATE.TITLE")%></TITLE>
...
<bsp:container title='<%=ResourcesFactory.getString("PRODUCT.UPDATE.TITLE")%>' >
<bsp:containbutton action="product.cmd?method=update" text='<%=ResourcesFactory.getString("COMMON.SAVE")%>' onclick="forSave()"></bsp:containbutton>
...
<div align="center">
  <table width="100%" cellpadding="0" class="tblContent">
                    ...
                    <td class="tdRight"><html:text name="itemProductid" readonly="true" property="itemProductid" size="30" maxlength="30" /></td>
                    </tr>                    
					<tr>
...
if(!__checkMoney(itemUnitprice)){alert('<%=ResourcesFactory.getString("PRODUCT.INVALIDPRICE")%>');return;}
  ...
  document.forms[0].action ="product.cmd?method=update";
