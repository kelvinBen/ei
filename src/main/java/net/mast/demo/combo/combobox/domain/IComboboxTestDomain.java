package net.mast.demo.combo.combobox.domain;
...
public abstract interface IComboboxTestDomain
{
 ...
 * Qualified Name:     net.mast.demo.combo.combobox.domain.IComboboxTestDomain
