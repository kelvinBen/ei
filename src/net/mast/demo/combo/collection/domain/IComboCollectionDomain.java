package net.mast.demo.combo.collection.domain;
...
public abstract interface IComboCollectionDomain
{
 ...
 * Qualified Name:     net.mast.demo.combo.collection.domain.IComboCollectionDomain
